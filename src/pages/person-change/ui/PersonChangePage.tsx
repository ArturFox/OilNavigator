...
// export function PersonChangePage ({personsMapProps, brigadesProps}: Props) {
...
//     const personEmpty = Boolean(!person.id);
...
//                      {personEmpty ? "Добавте человека" : `${person.name} - ${person.surname}`}
//                 </div>
