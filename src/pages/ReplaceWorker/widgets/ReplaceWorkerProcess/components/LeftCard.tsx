...
export function LeftCard (
    ...
    return (
        ...
        <article
            ...
            >
                <h3
                    className={styles["leftCard__blockBrigadeName"]}
                >
                ...
                <div
                    className={styles["leftCard__blockPersonInfo"]}
                >
                ...
                <div
                    className={styles["leftCard__blockJob"]}
                >
                    ...
                    <span
                        className={styles["leftCard__jobText"]}
                    >
                ...
                <div
                    className={`
                        ${styles["leftCard__blockProblem"]}
                    `}
                >   
                    <span
                        className={styles["leftCard__titleProblem"]}
                    >
                    ...
                    {arrProblemPersonToReplace.length > 0 
                        ? (
                            <span
                                className={styles["leftCard__textProblem"]}
                            >
